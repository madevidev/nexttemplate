...
export type InferClientTypesShallow<T> = T extends AnyString | AnyID | AnyNumber | AnyBoolean ? T['_shape'] : T extends AnyScalar ? T['_output'] : T extends AnyEnum ? T['_inner'] : T extends AnyUnion ? {
    $on: {
        __typename: keyof {
...
} : T extends AnyList ? InferClientTypesRaw<T['_shape']>[] : T extends AnyPaginatedList ? T['_inner'] : T extends AnyOptional ? InferClientTypesRaw<T['_shape']> | null | undefined : T extends AnyOmitResolver ? InferClientTypesRaw<T['_shape']> : T extends AnyArgs ? (args?: InferArg<T>) => InferClientTypes<T['_shape']> : T extends AnyRef ? InferClientTypesRaw<T['_inner']> : T;
